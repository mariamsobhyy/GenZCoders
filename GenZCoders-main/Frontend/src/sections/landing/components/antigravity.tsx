...
const AntigravityInner: React.FC<AntigravityProps> = ({
  ...
  return (
    <instancedMesh ref={meshRef} {...({ args: [undefined, undefined, count] } as any)}>
      {particleShape === 'capsule' && <capsuleGeometry {...({ args: [0.1, 0.4, 4, 8] } as any)} />}
      {particleShape === 'sphere' && <sphereGeometry {...({ args: [0.2, 16, 16] } as any)} />}
      {particleShape === 'box' && <boxGeometry {...({ args: [0.3, 0.3, 0.3] } as any)} />}
      {particleShape === 'tetrahedron' && <tetrahedronGeometry {...({ args: [0.3] } as any)} />}
